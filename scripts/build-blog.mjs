...
${sections}
        ...
        <div class="sl-ed-authorend">
          <span style="display:block;width:64px;height:64px;border-radius:50%;overflow:hidden;flex-shrink:0"><img src="/ceo-shine.avif" alt="" width="64" height="64" style="width:100%;height:100%;object-fit:cover;object-position:50% 0;transform:scale(2.4);transform-origin:50% 7%;border-radius:0" loading="lazy" decoding="async"></span>
